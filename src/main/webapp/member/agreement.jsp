...
function send(){
  ...
  if (frm.agree.checked == false){ //이건 name을 검색하는 방식, getElementById은 id를 검색하는 방식
 ...
 <!-- ********************************부트********************************************************* -->
  ...
  <div class="col-md-12">
    ...
    <FORM class="form-horizontal" name="frm" method="post"
      action="./create.jsp" onsubmit="return send();">

      <DIV class='content' style="text-align: center;">
        <textarea cols="100" rows="14" readonly="readonly"
          style='resize: none;'>Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
제1조(목적 등) 
      ...
      <div class="form-group">
        <div class="col-sm-12 text-center">
          ...
          <button class="btn btn-primary" type="submit">
            <i class="fa fa-check spaceLeft"></i>가입
          </button>
